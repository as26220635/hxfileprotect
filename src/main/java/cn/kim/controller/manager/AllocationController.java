...
public class AllocationController extends BaseController {
    ...
    public String webConfig(Model model) throws Exception {
        ...
        //日志保留时间(天)
        model.addAttribute("WEBCONFIG_LOG_RETAIN_TIME", AllocationUtil.get("WEBCONFIG_LOG_RETAIN_TIME"));
    ...
    public ResultState webConfigUpdate(@RequestParam Map<String, Object> mapParam) throws Exception {
        try {
            ...
            AllocationUtil.put("WEBCONFIG_LOG_RETAIN_TIME", mapParam.get("WEBCONFIG_LOG_RETAIN_TIME"));
            //刷新参数
            WebConfig.init();
        } catch (Exception e) {
            return resultError(e);

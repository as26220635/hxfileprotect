...
public class PjaxInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (path.startsWith("/share/") || path.contains(LoginController.OAUTH_PATH) || path.contains(ManagerController.LAYOUT_PATH) || path.contains("error/") || path.equals("/admin") || path.equals("/admin/")) {
            return true;
        }

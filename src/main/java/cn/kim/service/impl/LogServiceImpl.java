...
public class LogServiceImpl extends BaseServiceImpl implements LogService {
    ...
    @Override
    public void clearLog(String lessDate) throws Exception {
        Map<String, Object> paramMap = Maps.newHashMapWithExpectedSize(1);
        paramMap.put("LESS_DATE", lessDate);
        baseDao.delete(NameSpace.LogMapper, "clearLogText", paramMap);
        baseDao.delete(NameSpace.LogMapper, "clearLog", paramMap);
    }
}

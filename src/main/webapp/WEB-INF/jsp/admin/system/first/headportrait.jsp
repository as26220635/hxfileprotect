...
<form role="form" enctype="multipart/form-data" method="post" id="uploadImg" name="uploadImg">
    <div class="embed-responsive embed-responsive-16by9">
        <div class="embed-responsive-item pre-scrollable">
            <img alt="" src="${BASE_URL}${Url.IMG_URL}${activeUser.avatar}" id="cut-img"
...
<script>
    ...
    function PageInit() {
        ...
        this.portraitUpload = function () {
            ...
            var alert = $('#alert');
            fileUp.portrait(portrait, '${BASE_URL}${Url.EDIT_HEADPORTRAIT}', _this.getExtraData);
            ...
            portrait.on('fileuploaded', function (event, data) {
                if (!data.response.status) {
                    ...
                    $(".headportrait").each(function () {
                        $(this).prop("src", '${activeUser.avatar}');
                    });
                } else {
...
//                    img.removeAttr('src');
            ...
            function updateCords(obj) {
                ...
                $("#w").val(obj.w);
                $("#h").val(obj.h);
                $("#sw").val($('.jcrop-holder').css('width'));
                $("#sh").val($('.jcrop-holder').css('height'));
            }
        };

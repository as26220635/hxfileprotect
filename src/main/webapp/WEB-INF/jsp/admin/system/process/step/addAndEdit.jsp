...
<form id="addAndEditForm">
    ...
    <div class="form-group has-feedback">
        <label>步骤名称:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.SYS_PROCESS_STEP, "SPS_NAME")}
               value="${SPS.SPS_NAME}">
    </div>
    <div class="form-group has-feedback">
        <label>步骤类型:</label>
    ...
    <div class="form-group has-feedback">
        ...
        <s:combobox sdtCode="SYS_STEP_TYPE"
                    custom='${fns:validField(TableName.SYS_PROCESS_STEP,"SPS_STEP_TYPE")}'
                    value="${SPS.SPS_STEP_TYPE}"></s:combobox>
    </div>
    <div class="form-group has-feedback">
        <label>步骤顺序:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.SYS_PROCESS_STEP, "SPS_ORDER")}
               value="${SPS.SPS_ORDER}">
    </div>
    <div class="form-group has-feedback">
        <label>步骤流程状态:</label>
        <s:combobox sdtCode="SYS_PROCESS_STATUS"
                    custom='${fns:validField(TableName.SYS_PROCESS_STEP,"SPS_PROCESS_STATUS")}'
                    value="${SPS.SPS_PROCESS_STATUS}"></s:combobox>
    </div>
    <div class="form-group has-feedback">
        <label>是否验证超时:</label>
        <s:combobox sdtCode="SYS_YES_NO"
                    custom='${fns:validField(TableName.SYS_PROCESS_STEP,"SPS_IS_OVER_TIME")}'
                    value="${SPS.SPS_IS_OVER_TIME}" defaultValue="0"></s:combobox>
    </div>
    <div class="form-group has-feedback">
        <label>超时时间(分,默认为24小时、1440分钟):</label>
        <input type="text" class="form-control" ${fns:validField(TableName.SYS_PROCESS_STEP, "SPS_OVER_TIME")}
               value="${SPS.SPS_OVER_TIME}">
    </div>
    <div class="form-group has-feedback">
        <label>是否无视状态编辑:</label>
        <s:combobox sdtCode="SYS_YES_NO"
                    custom='${fns:validField(TableName.SYS_PROCESS_STEP,"SPS_IS_EDIT")}'
                    value="${SPS.SPS_IS_EDIT}"></s:combobox>
    </div>
    <div class="form-group has-feedback">
        <label>步骤标记:</label>
        <input type="text" class="form-control" ${fns:validField(TableName.SYS_PROCESS_STEP, "SPS_TAB")}
               value="${SPS.SPS_TAB}">
    </div>
    <div class="form-group has-feedback">
        <label>是否前进校验:</label>
        <s:combobox sdtCode="SYS_YES_NO"
                    custom='${fns:validField(TableName.SYS_PROCESS_STEP,"SPS_IS_ADVANCE_CHECK")}'
                    value="${SPS.SPS_IS_ADVANCE_CHECK}" defaultValue="0"></s:combobox>
    </div>
    <div class="form-group has-feedback">
        <label>是否退回校验:</label>
        <s:combobox sdtCode="SYS_YES_NO"
                    custom='${fns:validField(TableName.SYS_PROCESS_STEP,"SPS_IS_RETREAT_CHECK")}'
                    value="${SPS.SPS_IS_RETREAT_CHECK}" defaultValue="0"></s:combobox>
    </div>
    <div class="form-group has-feedback">
        <label>是否前进执行:</label>
        <s:combobox sdtCode="SYS_YES_NO"
                    custom='${fns:validField(TableName.SYS_PROCESS_STEP,"SPS_IS_ADVANCE_EXECUTE")}'
                    value="${SPS.SPS_IS_ADVANCE_EXECUTE}" defaultValue="0"></s:combobox>
    </div>
    <div class="form-group has-feedback">
        <label>是否退回执行:</label>
        <s:combobox sdtCode="SYS_YES_NO"
                    custom='${fns:validField(TableName.SYS_PROCESS_STEP,"SPS_IS_RETREAT_EXECUTE")}'

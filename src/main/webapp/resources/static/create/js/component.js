...
tableView = {
    ...
    init: function (options) {
        ...
        if (options.searchBtn != undefined) {
            //0.3秒只能点击一次
            options.searchBtn.addClass('btn-sm').addClass('disabled-0.3s');
        ...
        if (options.resetBtn != undefined) {
            //0.3秒只能点击一次
            options.resetBtn.addClass('btn-sm').addClass('disabled-0.3s');
        ...
        if (options.clearBtn != undefined) {
            //0.3秒只能点击一次
            options.clearBtn.addClass('disabled-0.3s');
